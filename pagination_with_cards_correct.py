"""
pagination_with_cards_correct.py - Test avec la vraie structure Highlight
"""
...
# Test avec les vrais objets Highlight
if __name__ == "__main__":
    ...
    # Créer des highlights de test avec la BONNE structure
    test_highlights = []
    book_id = uuid.uuid4()  # Un ID de livre pour tous
    ...
    for i in range(500):  # 500 highlights de test
        h = Highlight(
            ...
            book_id=book_id,
            page_number=i // 3 + 1,
            text=f"Texte extrait #{i+1}: Lorem ipsum dolor sit amet, consectetur adipiscing elit. "
    ...
    def on_highlight_click(highlight):
        print(f"Clic sur highlight #{highlight.highlight_number}, page {highlight.page_number}")
